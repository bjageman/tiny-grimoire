    ...
    <div className={cn(
      ...
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-500 text-sm">A tool for tracking in-person games</p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className={cn("text-sm mt-1 leading-relaxed", isLightModeActive ? "text-gray-600" : "text-gray-500")}>
                  Keep track of character claims and player statuses as a player.
                </p>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className={cn("text-sm mt-1 leading-relaxed", isLightModeActive ? "text-gray-600" : "text-gray-500")}>
                  Players submit preferences based on character type, then the grim is randomly assembled.
                </p>
                <div className="flex gap-2 mt-3">
